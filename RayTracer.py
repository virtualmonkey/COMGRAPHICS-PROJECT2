...
# Lights
r.dirLight = DirectionalLight(direction = V3(1, -1, -1), intensity = 0.5)
...
r.scene.append( AABB(V3(-1, 1.5, -5), V3(0.5,0.5,0.5) , obsidianMat))
r.scene.append( AABB(V3(-0.5,  1.5, -5), V3(0.5,0.5,0.5) , obsidianMat))
r.scene.append( AABB(V3(0, 1.5, -5), V3(0.5,0.5,0.5) , obsidianMat))
r.scene.append( AABB(V3(0.5, 1.5, -5), V3(0.5,0.5,0.5) , obsidianMat))

r.scene.append( AABB(V3(-0.5, 1, -5), V3(0.5,0.5,0.5) , obsidianMat))
r.scene.append( AABB(V3(0, 1, -5), V3(0.5,0.5,0.5) , glass))
r.scene.append( AABB(V3(0, 0.5, -5), V3(0.5,0.5,0.5) , obsidianMat))
r.scene.append( AABB(V3(-0.5, 0.5, -5), V3(0.5,0.5,0.5) , glass))
r.scene.append( AABB(V3(-0.5, 0, -5), V3(0.5,0.5,0.5) , obsidianMat))
r.scene.append( AABB(V3(0, 0, -5), V3(0.5,0.5,0.5) , glass))
...
r.scene.append( AABB(V3(-1, -0.5, -4), V3(0.7,0.6,0.1) , mirror))
r.scene.append( AABB(V3(-1, -0.5, -3), V3(0.5,0.5,0.5) , pumpkinMat))
r.scene.append( AABB(V3(-1.25, -0.5, -2), V3(0.5,0.5,0.5) , pumpkinMat))
...
r.scene.append( AABB(V3(1, -0.5, -4), V3(0.75,0.6,0.1) , mirror))
